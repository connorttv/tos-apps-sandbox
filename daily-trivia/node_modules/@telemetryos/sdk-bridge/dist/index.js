...
const m = Object.freeze({
  status: "aborted"
}), L = (s) => ({ status: "dirty", value: s }), b = (s) => ({ status: "valid", value: s }), re = (s) => s.status === "aborted", ae = (s) => s.status === "dirty", j = (s) => s.status === "valid", B = (s) => typeof Promise < "u" && s instanceof Promise;
var l;
(function(s) {
...
class _ {
  ...
  "~validate"(e) {
    ...
    return this._parseAsync({ data: e, path: [], parent: t }).then((n) => j(n) ? {
      value: n.value
    } : {
      issues: t.common.issues
    });
...
function Fe(s, e) {
  return !!((e === "v4" || !e) && $e.test(s) || (e === "v6" || !e) && Ve.test(s));
}
function We(s, e) {
  if (!Re.test(s))
    return !1;
...
function qe(s, e) {
  return !!((e === "v4" || !e) && Me.test(s) || (e === "v6" || !e) && Le.test(s));
}
class O extends _ {
  _parse(e) {
    ...
    for (const n of this._def.checks)
      if (n.kind === "min")
        ...
        H || (H = new RegExp(Ee, "u")), H.test(e.data) || (a = this._getOrReturnCtx(e, a), c(a, {
          validation: "emoji",
          code: o.invalid_string,
          message: n.message
        }), r.dirty());
        ...
        message: n.message
      }), r.dirty()) : n.kind === "datetime" ? Ue(n).test(e.data) || (a = this._getOrReturnCtx(e, a), c(a, {
        code: o.invalid_string,
        validation: "datetime",
        message: n.message
        ...
        validation: "date",
        message: n.message
      }), r.dirty()) : n.kind === "time" ? Be(n).test(e.data) || (a = this._getOrReturnCtx(e, a), c(a, {
        code: o.invalid_string,
        validation: "time",
        message: n.message
      }), r.dirty()) : n.kind === "duration" ? Ie.test(e.data) || (a = this._getOrReturnCtx(e, a), c(a, {
        validation: "duration",
        code: o.invalid_string,
        message: n.message
...
class z extends _ {
  ...
  _parse(e) {
    ...
    const a = new k();
    for (const n of this._def.checks)
      n.kind === "int" ? y.isInteger(e.data) || (r = this._getOrReturnCtx(e, r), c(r, {
        code: o.invalid_type,
        expected: "integer",
        received: "float",
        message: n.message
        ...
        exact: !1,
        message: n.message
      }), a.dirty()) : n.kind === "multipleOf" ? He(e.data, n.value) !== 0 && (r = this._getOrReturnCtx(e, r), c(r, {
...
class w extends _ {
  _parse(e) {
    ...
    if (a.minLength !== null && t.data.length < a.minLength.value && (c(t, {
      ...
      return Promise.all([...t.data].map((i, d) => a.type._parseAsync(new A(t, i, t.path, d)))).then((i) => k.mergeArray(r, i));
    const n = [...t.data].map((i, d) => a.type._parseSync(new A(t, i, t.path, d)));
...
function I(s) {
  if (s instanceof x) {
    ...
    ...s._def,
    type: I(s.element)
  }) : s instanceof N ? N.create(I(s.unwrap())) : s instanceof M ? M.create(I(s.unwrap())) : s instanceof R ? R.create(s.items.map((e) => I(e))) : s;
}
class x extends _ {
  constructor() {
  ...
  _parse(e) {
    ...
    const f = [];
    for (const h of i) {
      const v = n[h], V = a.data[h];
      f.push({
        key: { status: "valid", value: h },
        value: v._parse(new A(a, V, a.path, h)),
    ...
    return a.common.async ? Promise.resolve().then(async () => {
      const h = [];
      for (const v of f) {
        const V = await v.key, be = await v.value;
        h.push({
          key: V,
          value: be,
  ...
  keyof() {
    return ye(y.objectKeys(this.shape));
  }
}
x.create = (s, e) => new x({
  shape: () => s,
...
function G(s, e) {
  ...
  if (t === u.object && r === u.object) {
    const a = y.objectKeys(e), n = y.objectKeys(s).filter((d) => a.indexOf(d) !== -1), i = { ...s, ...e };
    for (const d of n) {
      const f = G(s[d], e[d]);
      if (!f.valid)
        return { valid: !1 };
...
class W extends _ {
  _parse(e) {
    const { status: t, ctx: r } = this._processInputParams(e), a = (n, i) => {
      ...
      return d.valid ? ((ae(n) || ae(i)) && t.dirty(), { status: t.value, value: d.data }) : (c(r, {
...
class R extends _ {
  _parse(e) {
    ...
    const n = [...r.data].map((i, d) => {
      ...
      return f ? f._parse(new A(r, i, r.path, d)) : null;
    }).filter((i) => !!i);
...
class fe extends _ {
  ...
  _parse(e) {
    ...
    const a = this._def.keyType, n = this._def.valueType, i = [...r.data.entries()].map(([d, f], h) => ({
      key: a._parse(new A(r, d, r.path, [h, "key"])),
      ...
      return Promise.resolve().then(async () => {
        for (const f of i) {
          ...
          if (h.status === "aborted" || v.status === "aborted")
            return m;
          (h.status === "dirty" || v.status === "dirty") && t.dirty(), d.set(h.value, v.value);
        }
...
class D extends _ {
  _parse(e) {
    ...
    const d = [...r.data.values()].map((f, h) => n._parse(new A(r, f, r.path, h)));
  ...
  _parse(e) {
    ...
    if (n.addIssue = n.addIssue.bind(n), a.type === "preprocess") {
      ...
      if (r.common.async)
        return Promise.resolve(i).then(async (d) => {
          ...
          return f.status === "aborted" ? m : f.status === "dirty" || t.value === "dirty" ? L(f.value) : f;
        });
      {
        if (t.value === "aborted")
          return m;
        ...
        return d.status === "aborted" ? m : d.status === "dirty" || t.value === "dirty" ? L(d.value) : d;
      }
    }
    ...
    if (a.type === "transform")
      if (r.common.async === !1) {
        ...
        return this._def.schema._parseAsync({ data: r.data, path: r.path, parent: r }).then((i) => j(i) ? Promise.resolve(a.transform(i.value, n)).then((d) => ({
          status: t.value,
          value: d
        })) : m);
    y.assertNever(a);
  ...
  _parse(e) {
    ...
    if (r.common.async)
      return (async () => {
        ...
        return n.status === "aborted" ? m : n.status === "dirty" ? (t.dirty(), L(n.value)) : this._def.out._parseAsync({
          data: n.value,
          path: r.path,
          parent: r
        });
...
const Qe = xe({
  type: ke("client"),
  telemetrySdkVersion: T(),
  applicationSpecifier: T(),
  applicationInstance: T(),
  runtime: Ye(["window", "worker"]),
  name: T(),
  data: ve(),
  responseName: T().optional(),
  subscriptionName: T().optional(),
  unsubscribeName: T().optional()
});
function Ke(s) {
...
class et {
   ...
   */
  bind() {
    this._windowMessageHandler = (e) => {
      var t;
      if (e.source === window)
        return;
      const r = Qe.safeParse(e.data);
      if (!r.success) {
        const n = e.data;
        n && typeof n == "object" && (n.type === "client" || n.telemetrySdkVersion || n.applicationSpecifier) && console.warn("[sdk-bridge] Received a message that looks like a client message but failed schema validation. This may indicate a version mismatch between the SDK and the host environment.", r.error.issues);
        return;
      }
      const a = r.data;
      (t = this.onMessage) === null || t === void 0 || t.call(this, a);
   ...
   */
  send(e) {
    for (let t = 0; t < window.frames.length; t += 1)
      window.frames[t].postMessage(Ge(e), "*");
  }
}
export {
  et as Bridge,
  Xe as bridgeMessageValidator,
  Qe as clientMessageValidator,
  Ge as formatBridgeMessage,
  Ke as formatClientMessage
};
