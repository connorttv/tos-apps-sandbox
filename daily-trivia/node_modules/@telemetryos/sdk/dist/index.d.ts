...
export { Accounts, Applications, Currency, DependencyHandle, Devices, Environment, Media, Mqtt, Navigation, Proxy, Store, StoreSlice, Users, Weather, bridgeMessageValidator, formatBridgeMessage, clientMessageValidator, formatClientMessage, type Application, type ApplicationSourceKind, type ApplicationStatus, type ApplicationVersion, type BackgroundWorker, type BridgeMessage, type CitiesSearchParams, type ClientMessage, type ColorScheme, type CurrencyRates, type CurrencyRatesParams, type CurrencySymbols, type DailyForecast, type DailyForecastData, type DailyForecastParams, type DependencyResult, type DeviceCapability, type HourlyForecast, type HourlyForecastData, type HourlyForecastParams, type MediaContent, type MediaFolder, type MediaPickerOptions, type MediaSelection, type MessageHandler, type MountPoint, type MqttBrokerInfo, type MqttConnectOptions, type MqttConnectionStatus, type MqttMessage, type MqttPublishOptions, type MqttSubscribeOptions, type SubscriptionResult, type WeatherAlert, type WeatherAlertSeverity, type WeatherAlerts, type WeatherAlertsParams, type WeatherCity, type WeatherConditions, type WeatherConditionsParams, type WeatherPartOfDay, } from '@telemetryos/root-sdk';
 ...
 * @throws {Error} If called before configure() or after destroy()
 */
export declare function subscribe(...args: Parameters<Client['subscribe']>): Promise<import("@telemetryos/root-sdk").SubscriptionResult<void>>;
/**
 ...
 * @throws {Error} If called before configure() or after destroy()
 */
export declare function store(): import("@telemetryos/root-sdk").Store;
/**
 ...
 * @throws {Error} If called before configure() or after destroy()
 */
export declare function applications(): import("@telemetryos/root-sdk").Applications;
/**
 ...
 */
export declare function currency(): import("@telemetryos/root-sdk").Currency;
/**
 ...
 * @returns The Playlist API object
 * @throws {Error} If called before configure() or after destroy()
 */
export declare function playlist(): import("./playlist.js").Playlist;
/**
 * Provides access to the overrides API for managing content overrides.
 * @returns The Overrides API object
 * @throws {Error} If called before configure() or after destroy()
 */
export declare function overrides(): import("./overrides.js").Overrides;
/**
 ...
 * @throws {Error} If called before configure() or after destroy()
 */
export declare function mqtt(): import("@telemetryos/root-sdk").Mqtt;
